...
# general setup
stage=2
recipe_root=/data/guyf/DiariZen/recipes/diar_ssl
exp_root=$recipe_root/exp
conf_dir=$recipe_root/conf

# training setup
use_dual_opt=false  # true for wavlm_updated_conformer.toml; false for the others
#train_conf=$conf_dir/wavlm_updated_conformer.toml
# train_conf=$conf_dir/wavlm_frozen_conformer.toml
#train_conf=$conf_dir/wavlm_frozen_att_ami_mult.toml
train_conf=$conf_dir/wavlm_updated_att.toml
# train_conf=$conf_dir/fbank_conformer.toml
# train_conf=$conf_dir/pyannote_baseline.toml
#train_conf=$conf_dir/wavlm_frozen_zipformer_mult.toml
...
collar=0
REF_DIR=$data_dir
dscore_dir=/data/guyf/DiariZen/dscore
...
embedding_model=/data/guyf/.cache/huggingface/hub/wespeaker/wespeaker_cn_cnceleb_resnet34_LM.onnx    # it's necessary to have "pyannote" in your directory path
