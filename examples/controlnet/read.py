...
if __name__ == "__main__":
    # 读取图像（假设是RGB格式）
    original_rgb = cv2.cvtColor(cv2.imread("./image_test_part003_00000001_target.png"), cv2.COLOR_BGR2RGB)
    moire_rgb = cv2.cvtColor(cv2.imread('./image_test_part003_00000001_source.png'), cv2.COLOR_BGR2RGB)
    ...
    # 保存结果
    cv2.imwrite('./blended_result.png', cv2.cvtColor(blended_rgb, cv2.COLOR_RGB2BGR))
    print("混合完成！")
    ...
    # print(result)
    compare_images("./image_test_part003_00000001_target.png",  "./blended_result.png")
