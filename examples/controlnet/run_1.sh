...
export OUTPUT_DIR="./model/demoire_4_30_bhd"
export HF_HUB_OFFLINE=1


accelerate launch --mixed_precision="fp16" --multi_gpu train_controlnet_sdxl_1.py \
 --pretrained_model_name_or_path=$MODEL_DIR \
 --output_dir=$OUTPUT_DIR \
 --dataset_name='/data/guyf/1/diff/datasets/fill50k/fill50k_bhd.py' \
